...
Revision ID: d8f12f76931a
Revises: 
Create Date: 2025-04-15 07:25:47.553435
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['fan_id'], ['fan.id'], ),
    sa.ForeignKeyConstraint(['wallpaper_id'], ['wallpaper.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['id_wallpaper'], ['wallpaper.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
