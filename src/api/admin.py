...
from .models import db, User,Fan,Artista, Tags,Wallpaper,TagsWallpaper, Seguidores,Favoritos, Coments,MeGusta
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Seguidores, db.session))
    ...
    admin.add_view(ModelView(MeGusta, db.session))
